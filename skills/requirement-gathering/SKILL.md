...
将模糊的想法转化为清晰的需求文档。作为设计（brainstorming）的前置环节，确保在开始设计"怎么做"之前，先明确"做什么"、"为什么做"，并补齐技术设计所需的约束、非功能、权限、数据契约等信息。
...
| **完整模式** | 新功能、复杂需求、涉及多方/多系统的需求 | 10 阶段 |
...
**轻量模式**执行阶段 ①②③⑦⑨，跳过 ④⑤⑥⑧；阶段 ⑩ 风险与假设视复杂度可选快速记录。

---

## 提问原则

- **一次一个主题** - 默认逐个问；同一主题的 2-3 个相关小问题可合并以提速
...
**核心问题：有哪些不确定点？失败或变更的风险？**

引导方向：
- 关键假设：外部依赖、数据可得性、用户行为、资源/时间
- 风险：影响、概率、应对/回滚策略

**示例问题：**
```
"这个需求有哪些前提假设？哪些还未验证？"
"最担心的风险是什么？如果发生会怎样？我们如何减轻或回滚？"
```
